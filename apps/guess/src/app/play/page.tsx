...
import { ApiError, createFreeplayGame } from "@/lib/guess-client";
...
/** Direct-link entry point for free play: creates a game immediately and hands off to the round UI. */

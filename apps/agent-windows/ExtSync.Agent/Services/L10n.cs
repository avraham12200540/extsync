...
public static class L10n
{
    ...
    private static readonly Dictionary<string, string> He = new()
    {
        ...
        ["Wiz.ProfileNote"] = "אם Chrome פתח בורר פרופילים - בחר פרופיל; ואם נפתח טאב ריק, לחץ 'העתק chrome://extensions' והדבק בשורת הכתובת.",
    ...
    private static readonly Dictionary<string, string> En = new()
    {
        ...
        ["Wiz.ProfileNote"] = "If Chrome opened a profile picker - pick a profile; if a blank tab opened, click 'Copy chrome://extensions' and paste it into the address bar.",

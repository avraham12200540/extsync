...
public static class L10n
{
    ...
    private static readonly Dictionary<string, string> He = new()
    {
        ...
        ["Wiz.GifCaption"] = "הסבר מצולם - כך טוענים את התוסף (לחץ לצפייה בגדול):",
        ["Wiz.GifOpenLarge"] = "▶ פתח את ההסבר המצולם",
        ["Wiz.Step1"] = "1. פתח את Chrome בפרופיל הרצוי ועבור לכתובת chrome://extensions (אפשר ללחוץ 'העתק chrome://extensions' ולהדביק בשורת הכתובת).",
        ["Wiz.Step2"] = "2. הפעל 'מצב מפתח' (Developer mode) בפינה העליונה.",
        ["Wiz.Step3"] = "3. לחץ 'טען פריט לא ארוז' (Load unpacked), הדבק את הנתיב שכבר העתקנו (Ctrl+V) ובחר את תיקיית active - בתוכה נמצא manifest.json.",
        ["Wiz.Step4"] = "4. חזור לכאן ולחץ 'טענתי את התוסף ✓'.",
    ...
    private static readonly Dictionary<string, string> En = new()
    {
        ...
        ["Wiz.GifCaption"] = "Video guide - how to load the extension (click to watch larger):",
        ["Wiz.GifOpenLarge"] = "▶ Open the video guide",
        ["Wiz.Step1"] = "1. Open Chrome in your desired profile and go to chrome://extensions (you can click 'Copy chrome://extensions' and paste it into the address bar).",
        ["Wiz.Step2"] = "2. Enable 'Developer mode' in the top corner.",
        ["Wiz.Step3"] = "3. Click 'Load unpacked', paste the path we already copied (Ctrl+V) and pick the active folder - manifest.json is inside it.",
        ["Wiz.Step4"] = "4. Come back here and click 'I loaded the extension ✓'.",

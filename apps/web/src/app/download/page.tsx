...
import { RefreshCw, FileSignature, Undo2 } from "lucide-react";
...
export default async function DownloadPage() {
  ...
  const features = [
    { Icon: RefreshCw, t: t("dl.f1.t"), d: t("dl.f1.d") },
    { Icon: FileSignature, t: t("dl.f2.t"), d: t("dl.f2.d") },
    { Icon: Undo2, t: t("dl.f3.t"), d: t("dl.f3.d") },
  ];
        ...
        <div className="mt-10 grid gap-5 sm:grid-cols-3">
          {features.map((b) => (
            <div key={b.t} className="lift rounded-xl border border-line bg-surface p-5 text-center shadow-card">
              <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-2xl bg-brand-gradient shadow-glow">
                <b.Icon className="h-6 w-6 text-white" strokeWidth={1.75} />
              </div>
